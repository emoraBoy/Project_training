                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <tbody>
                            <c:forEach items="${pageInfo.list}" var="orders" varStatus="i">
                                <tr>
                                    ...
                                    <td>${orders.oderDesc}</td>
                                    <td>${orders.payType==0?"微信":orders.payType==1?"支付宝":"其他"}</td>
                                    <td>${orders.oderStatus==1?"开启":"关闭"}</td>
